    ...
    <>
      ...
      {/* <div className="sticky top-20 z-40 backdrop-blur-sm bg-white/80">
        <div className="container mx-auto px-4 py-4">
          <Link 
            href={`/${lang}/services`}
            className="inline-flex items-center gap-2 text-neutral-500 hover:text-gold-700 font-medium transition-colors group"
          >
      ...
      <Section background="muted" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl">
                <h1 className="text-4xl md:text-7xl font-serif font-bold text-gold-900 mb-6">{service.title}</h1>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {service.benefits.map((benefit: string, i: number) => (
                        <div key={i} className="group p-8 rounded-2xl border border-neutral-100 bg-white hover:border-gold-100 hover:shadow-lg hover:shadow-gold-50/50 transition-all duration-300">
                            <div className="flex items-start gap-4">
                                <div className="p-2 rounded-lg bg-gold-50 text-gold-700 group-hover:bg-gold-700 group-hover:text-white transition-colors">
